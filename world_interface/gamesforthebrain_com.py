'''
This is the connector between our AI agent and the
gamesforthebrain.com/game/checkers website. This file provides an interface for
the agent to be able to interact with the game such that the agent can get the
current state of the game, and nominate the piece to move and move that piece.
'''
...
class game_iface():
    ...
    def __init__(self):
        # we could have multiple games running, so we want each instance to
        # have its own browser.
